		...
		<div id="main_body">&nbsp;
			<div id="form_container">
				...
				if (isset($_POST['submit'])) {
					if (empty($_POST['Title'])|| empty($_POST['MinVol']) || empty($_POST['MaxVol']) || empty($_POST['SMonth']) || empty($_POST['SDay']) || empty($_POST['SYear']) || empty($_POST['EMonth']) || empty($_POST['EDay']) || empty($_POST['EYear']) || empty($_POST['SHour']) || empty($_POST['SMin']) || empty($_POST['EHour']) || empty($_POST['EMin']) || empty($_POST['MinStud']) || empty($_POST['MaxStud']) || empty($_POST['Location'])){

  ...
  <head>
    ...
    <body>
        ...
        <div id=label>
			...
			<input id = "modifyEventVolunteer" style="top:9px;left:700px;" class="labelButton"  type="button" onClick="location.href='modifyEventVolunteer.php'" value="Modify event">
